...
const Footer = () => {
  return (
    <div className="mt-20 w-full bg-zinc-100 print:hidden">
      <div className="m-auto w-[95%] py-20 lg:w-[90%] xl:w-[1300px] px-12">
        <div className="grid grid-cols-1 gap-10 md:grid-cols-3">
          {/* Core Courses Section */}
          <div className="text-zinc-800">
            <h1 className="text-xl font-bold font-roboto">Core Courses</h1>
          ...
          <div className="text-zinc-800">
            <h1 className="text-xl font-bold font-roboto">Advanced Courses</h1>
            <div className="mt-5 flex flex-col gap-3 text-sm md:text-base">
          ...
          <div className="text-zinc-800">
            <h1 className="text-xl font-bold font-roboto">Social Links</h1>
